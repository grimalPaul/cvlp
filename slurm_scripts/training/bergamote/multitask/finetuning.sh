...
encoder_question_path=experiments/config_vladapter/factoryIA/embedding/encoder_question.json
encoder_passage_path=experiments/config_vladapter/factoryIA/embedding/encoder_passage.json
model_path=experiments/config_vladapter/factoryIA/embedding/config_model.json
