            ...
            relevant_items.append(
                {
                    ...
                    'input': row['input'],
                    'passages': passage2text(passages[indexes_passages]['passage'][0:k])
                })
...
if __name__ == '__main__':
    ...
    #print(relevant)
    # print relevant
    print(tabulate(relevant, headers='keys'))

    # print irrelevant
    #print(tabulate(irrelevant, headers='keys'))
